...
namespace MMS.Core.Localization.NumberFormats {
	/// <summary>
	...
	public static class NumberFormats {
		...
		public static string ToNumberFormat(this int number, string targetFormat) {
			...
			switch (targetFormat) {
				case Default: _str = number.ToString("N0"); break;
				case Hex: _str = number.ToString("X"); break;
				case Roman: _str = ((uint)number).ToRoman(); break;
				default:
