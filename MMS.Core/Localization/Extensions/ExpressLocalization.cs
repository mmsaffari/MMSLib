...
using MMS.Core.Localization.DataAnnotations;
using MMS.Core.Localization.Models;

namespace MMS.Core.Localization.Extensions {
	/// <summary>
	...
	/// </summary>
	public static class ExpressLocalization {
		...
		public static IMvcBuilder AddExpressLocalization<TLocalizationResource>(this IMvcBuilder builder, Action<ExpressLocalizationOptions> options)
			...
			builder.Services.Configure(_options.RequestLocalizationOptions);
